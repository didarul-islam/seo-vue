<template>
    <div
        class="section mt-0"
        style="
          background: url('demos/seo/images/sections/3.jpg') no-repeat top
            center;
      ...
      >
        <div class="container">
          ...
          <div
            id="oc-testi"
            class="owl-carousel testimonials-carousel carousel-widget clearfix"
            data-margin="0"
            data-pagi="true"
            data-loop="true"
            data-center="true"
            ...
            <div class="oc-item">
              <div class="testimonial">
                <div class="testi-image">
                  <a href="#"
                    ><img
                      src="demos/pet/images/testimonials/1.jpg"
            ...
            <div class="oc-item">
              <div class="testimonial">
                <div class="testi-image">
                  <a href="#"
                    ><img
                      src="demos/pet/images/testimonials/2.jpg"
                      alt="Customer Testimonails"
                  /></a>
                </div>
                <div class="testi-content">
            ...
            <div class="oc-item">
              <div class="testimonial">
                <div class="testi-image">
                  <a href="#"
                    ><img
                      src="demos/pet/images/testimonials/3.jpg"
                      alt="Customer Testimonails"
                  /></a>
                </div>
                <div class="testi-content">
            ...
            <div class="oc-item">
              <div class="testimonial">
                <div class="testi-image">
                  <a href="#"
                    ><img
                      src="demos/pet/images/testimonials/4.jpg"
                      alt="Customer Testimonails"
                  /></a>
                </div>
                <div class="testi-content">
