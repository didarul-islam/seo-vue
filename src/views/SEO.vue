    ...
    <section
      ...
      style="
        background-image: linear-gradient(
          ...
          url('demos/seo/images/services/seo-title.jpg');
      ...
      <div class="container clearfix mt-4">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">
            <a href="demo-seo-about.html">Services</a>
          </li>
      ...
      <div class="content-wrap pb-0">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-6">
              ...
              <p>
                ...
                vitae mollitia dignissimos ab qui aspernatur.
              </p>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt
                laborum, molestiae eum odit illo pariatur. Sapiente deserunt
                optio dignissimos maiores pariatur, expedita voluptate quibusdam
                distinctio beatae.
              </p>
              <a href="#" class="button button-rounded button-large nott ls0"
                >Get Started</a
              >
              <a
                href="demo-seo-contact.html"
                class="button button-rounded button-large button-light text-dark bg-white border nott ls0"
                >Contact Us</a
              >
            </div>
          ...
          <div class="heading-block border-bottom-0 center">
            <div class="badge badge-pill badge-default">Features</div>
          ...
          <div class="row mt-4 col-mb-50 mb-0">
            <div class="col-sm-6 col-lg-4">
              <div class="feature-box">
                <div class="fbox-icon mb-4">
                  <a href="#"
                    ><i class="icon-file-alt1 si-colored si-gplus border-0"></i
                  ></a>
                </div>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="feature-box">
                <div class="fbox-icon mb-4">
                  <a href="#"
                    ><i class="icon-mobile si-colored si-instagram border-0"></i
                  ></a>
                </div>
                <div class="fbox-content">
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="feature-box">
                <div class="fbox-icon mb-4">
                  <a href="#"
                    ><i class="icon-browser si-colored si-appstore border-0"></i
                  ></a>
                </div>
                <div class="fbox-content">
                  <h3 class="nott">Website Analytics</h3>
                  <p>
                    Canvas included 20+ custom designed Slider Pages with
                    Premium Sliders like Layer, Revolution, Swiper &amp; others.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="feature-box">
                <div class="fbox-icon mb-4">
                  <a href="#"
                    ><i class="icon-line-loader bg-info border-0"></i
                  ></a>
                </div>
                <div class="fbox-content">
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="feature-box">
                <div class="fbox-icon mb-4">
                  <a href="#"
                    ><i class="icon-line-code bg-danger border-0"></i
                  ></a>
                </div>
                <div class="fbox-content">
                  <h3 class="nott">Customizing Codes</h3>
                  <p>
                    Use any Font you like from Google Web Fonts, Typekit or
                    other Web Fonts. They will blend in perfectly.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="section mb-0">
          <div class="container">
            <div class="heading-block border-bottom-0 center">
              <div class="badge badge-pill badge-default">Causes</div>
        ...
        <div
          class="section mt-0"
          style="
            background: url('demos/seo/images/sections/1.jpg') no-repeat center
              center;
            background-size: cover;
            padding: 100px 0;
          "
                    ...
                    <div class="form-widget">
                      ...
                      >
                        ...
                        <div class="col-12 form-group mb-4">
                          <label for="template-contactform-website"
                            >Website:*</label
                          >
                          <input
                            type="text"
                            id="template-contactform-website"
